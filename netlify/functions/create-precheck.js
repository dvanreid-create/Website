...
exports.handler = async (event) => {
  ...
  const fields = {
    ...
    "Notes": [t(d.venuetype) && ("Venue: " + t(d.venuetype)), t(d.onsale) && ("On-sale: " + t(d.onsale)), t(d.sold) && ("Sold so far: " + t(d.sold) + (t(d.soldasof) ? (" as of " + t(d.soldasof)) : "")), t(d.notes)].filter(Boolean).join(" · "),
    "Contact email": email,
